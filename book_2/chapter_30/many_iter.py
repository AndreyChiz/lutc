...
for i in gen_y:
    print(i, end=" ")
print()
print("итератор gen_y исчерпан (normal)",'\n')
...
print("Проблема - создаётся новый список (smell)")
print([i for i in Squares(1, 5)])
print([i for i in Squares(1, 5)], '\n')

print('Проверка на вхождение в итератор (normal)')
print(100 in Squares(1, 5))
print(1 in Squares(1, 5))

print()
print('Проблема - исчерпывание итератора (smell)')
new_x = Squares(1, 5)
duble_x = (tuple(new_x), tuple(new_x))
print(duble_x, "во втором кортеже исерпан", '\n')

print("Проблема - создаётся дополнительный список (smell)")
